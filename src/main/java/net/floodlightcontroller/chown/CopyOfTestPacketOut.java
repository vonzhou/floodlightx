...
public class CopyOfTestPacketOut implements IOFMessageListener, IFloodlightModule {
	...
	public String getName() {
		return CopyOfTestPacketOut.class.getSimpleName();
	}
	...
	public void init(FloodlightModuleContext context)
		...
		logger = LoggerFactory.getLogger(CopyOfTestPacketOut.class);
	}
